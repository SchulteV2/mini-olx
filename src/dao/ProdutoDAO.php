...
class ProdutoDAO {
    ...
    public static function getAll() {
        ...
        $stmt = $con->prepare("SELECT p.id as id, p.nome as nome, p.descricao, p.url_imagem_produto, p.preco, p.categoria_id, c.nome as categoria_nome FROM produtos p " .
                                "JOIN categorias c "  .
    ...
    public static function getById($id) {
        ...
        $stmt = $con->prepare("SELECT p.id as id, p.nome as nome, p.descricao, p.url_imagem_produto, p.preco, p.categoria_id, c.nome as categoria_nome FROM produtos p " .
                                "JOIN categorias c "  .
                                "ON (p.categoria_id = c.id) WHERE p.id =:id LIMIT 1");
    ...
    public static function create($nome, $preco, $imagem, $categoria_id, $descricao) {
        ...
        $stmt = $con->prepare("INSERT INTO produtos (nome, preco, descricao, url_imagem_produto, categoria_id) VALUES (:nome, :preco, :descricao, :url_imagem_produto, :categoria_id)");
    ...
    public static function update($id, $nome, $preco, $imagem, $categoria_id, $descricao) {
        ...
        $stmt = $con->prepare("UPDATE produtos SET nome=:nome, descricao=:descricao, url_imagem_produto=:url_imagem_produto, 
